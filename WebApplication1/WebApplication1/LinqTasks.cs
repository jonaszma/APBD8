...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(p => p.Job == "Backend programmer");
            return result;
        }
        ...
        {
            IEnumerable<Emp> result =Emps.Where(p => p.Job == "Backend programmer").Where(p=>p.Salary>1000).OrderBy(p=>p.Ename);
            return result;
        }
        ...
        {
            int result = Emps.Max(p=>p.Salary);;
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.Where(p => p.Salary == Emps.Max(p=>p.Salary));;
            return result;
        }
        ...
        {
            bool result = Emps.Any(p=>p.Job=="Backend programmer");
            return result;
        }
        ...
        {
            int result = arr.GroupBy(x=>x).Single(group=>group.Count()%2!=0).Key;
            //result=
            return result;
        }
        ...
        {
            IEnumerable<Dept> result = Depts.Where(dept=>Emps.All(emp=>emp.Deptno!=dept.Deptno)|| 
